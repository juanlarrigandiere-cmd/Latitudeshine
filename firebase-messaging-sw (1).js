...
messaging.onBackgroundMessage(function(payload) {
  ...
  self.registration.showNotification(title || 'Latitude Shine', {
    body: body || '',
    icon: icon || 'https://juanlarrigandiere-cmd.github.io/Latitudeshine/icon-192.png',
    badge: 'https://juanlarrigandiere-cmd.github.io/Latitudeshine/icon-192.png',
    data: payload.data || {}
  });
});
...
self.addEventListener('notificationclick', function(event) {
  ...
  event.waitUntil(clients.openWindow('https://juanlarrigandiere-cmd.github.io/Latitudeshine/'));
});
